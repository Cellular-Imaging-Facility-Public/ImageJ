...
#@ Integer (label="Band thickness", value=5, style="slider", min=0, max=15, stepSize=1, description="Thickness of the band around the nuclei in pixels") band_thickness
...
#@ Integer (label="Min Nucleus area", value=20, description="<html>Minimum area for the nucleus in pixels<sup>2</sup></html>") min_nucleus_area
#@ Integer (label="Max Nucleus area", value=100, description="<html>Minimum area for the nucleus in pixels<sup>2</sup></html>") max_nucleus_area
...
def prepareImageComposite():
	...
	IJ.log("Composite image prepared")
...
def prepareImageRGB():
	...
	IJ.log("RGB image prepared")

def prepareImageSplit():
	exit
